...
//     return await axios.put(`http://localhost:8080/projects/${id}`,{status:"Running"}).then(()=>fetchData(page).then((res)=>setProjectData(res.data)))
//   };

//   const handleClose = async (projectId, page) => {
//     return await axios.put(`http://localhost:8080/projects/${id}`,{status:"Closed"}).then(()=>fetchData(page).then((res)=>setProjectData(res.data)))
//   };

//   const handleCancel = async (projectId, page) => {
//     return await axios.put(`http://localhost:8080/projects/${id}`,{status:"Cancelled"}).then(()=>fetchData(page).then((res)=>setProjectData(res.data)))
//   };
...
//                   <tbody>
//                     {projectData.map((el) => (
//                       <tr className="projectRow" key={project._id}>
...
//                     <td><button onClick={()=>handleCancel(el._id,page)} id="cancle">Cancle</button></td>
//                       </tr>
//                     ))}
//                   </tbody>
//                 </table>
//               </div>
//               <div id="pagination">
//                 <button disabled={page===1} onClick={handleDecrementPage}>-</button>
//                 <button>{page}</button>
...
const ProjectList = () => {
  ...
  const handleStart = async (projectId, page) => {
    return await axios.put(`http://localhost:8080/projects/${projectId}`,{status:"Running"}).then(()=>fetchData(page).then((res)=>setProjectData(res.data)))
  };

  const handleClose = async (projectId, page) => {
    return await axios.put(`http://localhost:8080/projects/${projectId}`,{status:"Closed"}).then(()=>fetchData(page).then((res)=>setProjectData(res.data)))
  };

  const handleCancel = async (projectId, page) => {
    return await axios.put(`http://localhost:8080/projects/${projectId}`,{status:"Cancelled"}).then(()=>fetchData(page).then((res)=>setProjectData(res.data)))
  };
